...
namespace EPiPugPigConnector.EPiExtensions
{
    ...
    public static class PageDataExtensions
    {
        ...
        public static IEnumerable<PageData> GetDescendants(this PageData pageData, int levels = int.MaxValue)
        {
        ...
        /// <param name="levels">Level of how deep to look for descendants in page hiararchy.</param>
        /// <returns>Returns sequence of PageData of descendants for provided page.</returns>
        public static IEnumerable<T> GetDescendants<T>(this PageData pageData, int levels = int.MaxValue) where T : PageData
        {
